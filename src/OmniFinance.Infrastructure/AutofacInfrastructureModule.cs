...
using OmniFinance.Infrastructure.Data;
using OmniFinance.Infrastructure.Data.Queries;
using OmniFinance.Infrastructure.Email;
using OmniFinance.UseCases.AccountProfiles.Create;
using Module = Autofac.Module;

namespace OmniFinance.Infrastructure;
...
public class AutofacInfrastructureModule : Module
{
  ...
  private void LoadAssemblies()
  {
    ...
    var coreAssembly = Assembly.GetAssembly(typeof(AccountProfile));
    var infrastructureAssembly = Assembly.GetAssembly(typeof(AutofacInfrastructureModule));
    var useCasesAssembly = Assembly.GetAssembly(typeof(CreateAccountProfileCommand));
  ...
  {
    builder.RegisterType<ListAccountProfileQueryService>()
      .As<IListAccountProfilesQueryService>()
      .InstancePerLifetimeScope();
  }
  ...
  private void RegisterDevelopmentOnlyDependencies(ContainerBuilder builder)
  {
    ...
    //builder.RegisterType<FakeListAccountProfilesQueryService>()
    //  .As<IListAccountProfilesQueryService>()
    //  .InstancePerLifetimeScope();
  }
